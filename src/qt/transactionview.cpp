 ...
 */
    ...
    typeWidget->addItem(tr("Received Din from zDin"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDin"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDin));
