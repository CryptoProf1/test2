...
/* Dinero GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DINERO"
#define QAPP_ORG_DOMAIN "dinerocoin.org"
#define QAPP_APP_NAME_DEFAULT "DINERO-Qt"
#define QAPP_APP_NAME_TESTNET "DINERO-Qt-testnet"
