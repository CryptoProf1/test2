...
/** Utility functions used by the DINERO Qt UI.
 */
namespace GUIUtil
{
...
// Render DINERO addresses in monospace font
...
// Parse "dinero:" URI into recipient object, return true on successful parsing
