                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DINERO Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DINERO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dinero: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDIN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DINERO Core"), this);
    aboutAction->setStatusTip(tr("Show information about DINERO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DINERO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DINERO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DINERO addresses"));
    ...
    openAction->setStatusTip(tr("Open a DINERO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DINERO Core help message to get a list with possible DINERO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DINERO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DINERO network", "", count));
}
...
{
    QString strTitle = tr("DINERO Core"); // default title
