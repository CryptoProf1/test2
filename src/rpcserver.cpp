...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Dinero features */
        {"dinero", "masternode", &masternode, true, true, false},
        {"dinero", "listmasternodes", &listmasternodes, true, true, false},
        {"dinero", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dinero", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dinero", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dinero", "masternodedebug", &masternodedebug, true, true, false},
        {"dinero", "startmasternode", &startmasternode, true, true, false},
        {"dinero", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dinero", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dinero", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dinero", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dinero", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dinero", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dinero", "mnbudget", &mnbudget, true, true, false},
        {"dinero", "preparebudget", &preparebudget, true, true, false},
        {"dinero", "submitbudget", &submitbudget, true, true, false},
        {"dinero", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dinero", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dinero", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dinero", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dinero", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dinero", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dinero", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dinero", "checkbudgets", &checkbudgets, true, true, false},
        {"dinero", "mnsync", &mnsync, true, true, false},
        {"dinero", "spork", &spork, true, true, false},
        {"dinero", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"dinero", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
