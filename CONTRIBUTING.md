Contributing to DINERO Core
============================

The DINERO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DINERO Core project, and is not to be
confused with overall DINERO Network Protocol consensus changes.

Whether a pull request is merged into DINERO Core rests with the project merge
...
Patches that change DINERO consensus rules are considerably more involved than
...
Where a patch set proposes to change the DINERO consensus, it must have been
...
The project leader is the release manager for each DINERO Core release.
