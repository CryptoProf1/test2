...
#   c) node1 mines 32 blocks, so now node 0 has 60001din, node 1 has 4250din, node2 has none.
#   d) node0 sends 601 din to node2, in two transactions (301 din, then 300 din).
